...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight <=0)
    {
        ...
        nSubsidy = 480000 * COIN; // 1 billion coins for ico
    }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //#1
        const char* pszTimestamp = "YunLCoin gonna make an Impact on the altcoin market never seen before";
        CTransaction txNew;
        txNew.nTime = 1490421068;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
//        }
        ...
        //#1
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x83f028b01b9748c64c4d6270a37d2bb564d70510a4a6737f2efba55de2b3fa3b"));
        block.print();
